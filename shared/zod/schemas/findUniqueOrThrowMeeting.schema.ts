...
export const MeetingFindUniqueOrThrowSchema = z.object({ select: MeetingSelectObjectSchema.optional(), include: MeetingIncludeObjectSchema.optional(), where: MeetingWhereUniqueInputObjectSchema })