...
export const CrmSyncLogAggregateSchema = z.object({ orderBy: z.union([CrmSyncLogOrderByWithRelationInputObjectSchema, CrmSyncLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: CrmSyncLogWhereInputObjectSchema.optional(), cursor: CrmSyncLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), _count: z.union([ z.literal(true), CrmSyncLogCountAggregateInputObjectSchema ]).optional(), _min: CrmSyncLogMinAggregateInputObjectSchema.optional(), _max: CrmSyncLogMaxAggregateInputObjectSchema.optional(), _avg: CrmSyncLogAvgAggregateInputObjectSchema.optional(), _sum: CrmSyncLogSumAggregateInputObjectSchema.optional() })