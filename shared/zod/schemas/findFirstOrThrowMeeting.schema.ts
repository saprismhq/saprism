...
export const MeetingFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MeetingSelect> = z.object({
...
export const MeetingFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    clientId: z.boolean().optional(),
    clientName: z.boolean().optional(),
...
export const MeetingFindFirstOrThrowSchema: z.ZodType<Prisma.MeetingFindFirstOrThrowArgs> = z.object({ select: MeetingFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MeetingIncludeObjectSchema.optional()), orderBy: z.union([MeetingOrderByWithRelationInputObjectSchema, MeetingOrderByWithRelationInputObjectSchema.array()]).optional(), where: MeetingWhereInputObjectSchema.optional(), cursor: MeetingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MeetingScalarFieldEnumSchema, MeetingScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MeetingFindFirstOrThrowArgs>;

export const MeetingFindFirstOrThrowZodSchema = z.object({ select: MeetingFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => MeetingIncludeObjectSchema.optional()), orderBy: z.union([MeetingOrderByWithRelationInputObjectSchema, MeetingOrderByWithRelationInputObjectSchema.array()]).optional(), where: MeetingWhereInputObjectSchema.optional(), cursor: MeetingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MeetingScalarFieldEnumSchema, MeetingScalarFieldEnumSchema.array()]).optional() }).strict();