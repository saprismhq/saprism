...
export const CallSessionFindUniqueOrThrowSchema = z.object({ select: CallSessionSelectObjectSchema.optional(), include: CallSessionIncludeObjectSchema.optional(), where: CallSessionWhereUniqueInputObjectSchema })