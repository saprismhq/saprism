...
export const CallSessionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.CallSessionSelect> = z.object({
...
export const CallSessionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    meetingId: z.boolean().optional(),
    liveKitRoomName: z.boolean().optional(),
    liveKitToken: z.boolean().optional(),
...
export const CallSessionFindFirstOrThrowSchema: z.ZodType<Prisma.CallSessionFindFirstOrThrowArgs> = z.object({ select: CallSessionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CallSessionIncludeObjectSchema.optional()), orderBy: z.union([CallSessionOrderByWithRelationInputObjectSchema, CallSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: CallSessionWhereInputObjectSchema.optional(), cursor: CallSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CallSessionScalarFieldEnumSchema, CallSessionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.CallSessionFindFirstOrThrowArgs>;

export const CallSessionFindFirstOrThrowZodSchema = z.object({ select: CallSessionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => CallSessionIncludeObjectSchema.optional()), orderBy: z.union([CallSessionOrderByWithRelationInputObjectSchema, CallSessionOrderByWithRelationInputObjectSchema.array()]).optional(), where: CallSessionWhereInputObjectSchema.optional(), cursor: CallSessionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([CallSessionScalarFieldEnumSchema, CallSessionScalarFieldEnumSchema.array()]).optional() }).strict();