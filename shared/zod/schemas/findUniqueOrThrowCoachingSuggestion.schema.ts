...
export const CoachingSuggestionFindUniqueOrThrowSchema = z.object({ select: CoachingSuggestionSelectObjectSchema.optional(), include: CoachingSuggestionIncludeObjectSchema.optional(), where: CoachingSuggestionWhereUniqueInputObjectSchema })