...
const Schema: z.ZodType<Prisma.MeetingUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => MeetingUpsertWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => MeetingUpsertWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => MeetingUpdateWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => MeetingUpdateWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
      .union([
        z.lazy(() => MeetingUpdateManyWithWhereWithoutUserInputObjectSchema),
        z
          .lazy(() => MeetingUpdateManyWithWhereWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const MeetingUpdateManyWithoutUserNestedInputObjectSchema = Schema;
