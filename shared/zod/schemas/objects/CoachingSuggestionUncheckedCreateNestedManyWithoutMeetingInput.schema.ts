...
const Schema: z.ZodType<Prisma.CoachingSuggestionUncheckedCreateNestedManyWithoutMeetingInput> =
  z
    .object({
      create: z
        .union([
...
export const CoachingSuggestionUncheckedCreateNestedManyWithoutMeetingInputObjectSchema =
  Schema;
