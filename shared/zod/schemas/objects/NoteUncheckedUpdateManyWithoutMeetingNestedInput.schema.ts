...
const Schema: z.ZodType<Prisma.NoteUncheckedUpdateManyWithoutMeetingNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => NoteUpsertWithWhereUniqueWithoutMeetingInputObjectSchema,
          ),
          z
            .lazy(
              () => NoteUpsertWithWhereUniqueWithoutMeetingInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => NoteUpdateWithWhereUniqueWithoutMeetingInputObjectSchema,
          ),
          z
            .lazy(
              () => NoteUpdateWithWhereUniqueWithoutMeetingInputObjectSchema,
...
export const NoteUncheckedUpdateManyWithoutMeetingNestedInputObjectSchema =
  Schema;
