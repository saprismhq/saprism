...
const Schema: z.ZodType<Prisma.MeetingUpdateManyWithoutClientNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => MeetingUpdateManyWithWhereWithoutClientInputObjectSchema),
        z
          .lazy(() => MeetingUpdateManyWithWhereWithoutClientInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const MeetingUpdateManyWithoutClientNestedInputObjectSchema = Schema;
