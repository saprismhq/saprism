...
const Schema: z.ZodType<Prisma.CrmSyncLogUpdateManyWithoutMeetingNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CrmSyncLogUpdateManyWithoutMeetingNestedInputObjectSchema = Schema;
