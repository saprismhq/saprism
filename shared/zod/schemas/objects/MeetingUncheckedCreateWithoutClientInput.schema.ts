...
const Schema: z.ZodType<Prisma.MeetingUncheckedCreateWithoutClientInput> = z
  .object({
    ...
    notes: z
      .lazy(() => NoteUncheckedCreateNestedManyWithoutMeetingInputObjectSchema)
      .optional(),
...
export const MeetingUncheckedCreateWithoutClientInputObjectSchema = Schema;
