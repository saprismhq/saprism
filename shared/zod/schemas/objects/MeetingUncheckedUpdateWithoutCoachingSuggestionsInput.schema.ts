...
const Schema: z.ZodType<Prisma.MeetingUncheckedUpdateWithoutCoachingSuggestionsInput> =
  z
    .object({
      id: z
        .union([
...
export const MeetingUncheckedUpdateWithoutCoachingSuggestionsInputObjectSchema =
  Schema;
