...
const makeSchema = (): z.ZodObject<any> => z.object({
  ...
  upsert: z.union([z.lazy(() => CrmSyncLogUpsertWithWhereUniqueWithoutMeetingInputObjectSchema), z.lazy(() => CrmSyncLogUpsertWithWhereUniqueWithoutMeetingInputObjectSchema).array()]).optional(),
  createMany: z.lazy(() => CrmSyncLogCreateManyMeetingInputEnvelopeObjectSchema).optional(),
  set: z.union([z.lazy(() => CrmSyncLogWhereUniqueInputObjectSchema), z.lazy(() => CrmSyncLogWhereUniqueInputObjectSchema).array()]).optional(),
  disconnect: z.union([z.lazy(() => CrmSyncLogWhereUniqueInputObjectSchema), z.lazy(() => CrmSyncLogWhereUniqueInputObjectSchema).array()]).optional(),
  delete: z.union([z.lazy(() => CrmSyncLogWhereUniqueInputObjectSchema), z.lazy(() => CrmSyncLogWhereUniqueInputObjectSchema).array()]).optional(),
  ...
  update: z.union([z.lazy(() => CrmSyncLogUpdateWithWhereUniqueWithoutMeetingInputObjectSchema), z.lazy(() => CrmSyncLogUpdateWithWhereUniqueWithoutMeetingInputObjectSchema).array()]).optional(),
  updateMany: z.union([z.lazy(() => CrmSyncLogUpdateManyWithWhereWithoutMeetingInputObjectSchema), z.lazy(() => CrmSyncLogUpdateManyWithWhereWithoutMeetingInputObjectSchema).array()]).optional(),
  deleteMany: z.union([z.lazy(() => CrmSyncLogScalarWhereInputObjectSchema), z.lazy(() => CrmSyncLogScalarWhereInputObjectSchema).array()]).optional()
}).strict();
export const CrmSyncLogUncheckedUpdateManyWithoutMeetingNestedInputObjectSchema: z.ZodType<Prisma.CrmSyncLogUncheckedUpdateManyWithoutMeetingNestedInput> = makeSchema() as unknown as z.ZodType<Prisma.CrmSyncLogUncheckedUpdateManyWithoutMeetingNestedInput>;
export const CrmSyncLogUncheckedUpdateManyWithoutMeetingNestedInputObjectZodSchema = makeSchema();
