...
const Schema: z.ZodType<Prisma.MeetingUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const MeetingUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
