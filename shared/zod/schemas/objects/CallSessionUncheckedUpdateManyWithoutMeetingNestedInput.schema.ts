...
const makeSchema = (): z.ZodObject<any> => z.object({
  ...
  upsert: z.union([z.lazy(() => CallSessionUpsertWithWhereUniqueWithoutMeetingInputObjectSchema), z.lazy(() => CallSessionUpsertWithWhereUniqueWithoutMeetingInputObjectSchema).array()]).optional(),
  createMany: z.lazy(() => CallSessionCreateManyMeetingInputEnvelopeObjectSchema).optional(),
  set: z.union([z.lazy(() => CallSessionWhereUniqueInputObjectSchema), z.lazy(() => CallSessionWhereUniqueInputObjectSchema).array()]).optional(),
  disconnect: z.union([z.lazy(() => CallSessionWhereUniqueInputObjectSchema), z.lazy(() => CallSessionWhereUniqueInputObjectSchema).array()]).optional(),
  delete: z.union([z.lazy(() => CallSessionWhereUniqueInputObjectSchema), z.lazy(() => CallSessionWhereUniqueInputObjectSchema).array()]).optional(),
  ...
  update: z.union([z.lazy(() => CallSessionUpdateWithWhereUniqueWithoutMeetingInputObjectSchema), z.lazy(() => CallSessionUpdateWithWhereUniqueWithoutMeetingInputObjectSchema).array()]).optional(),
  updateMany: z.union([z.lazy(() => CallSessionUpdateManyWithWhereWithoutMeetingInputObjectSchema), z.lazy(() => CallSessionUpdateManyWithWhereWithoutMeetingInputObjectSchema).array()]).optional(),
  deleteMany: z.union([z.lazy(() => CallSessionScalarWhereInputObjectSchema), z.lazy(() => CallSessionScalarWhereInputObjectSchema).array()]).optional()
}).strict();
export const CallSessionUncheckedUpdateManyWithoutMeetingNestedInputObjectSchema: z.ZodType<Prisma.CallSessionUncheckedUpdateManyWithoutMeetingNestedInput> = makeSchema() as unknown as z.ZodType<Prisma.CallSessionUncheckedUpdateManyWithoutMeetingNestedInput>;
export const CallSessionUncheckedUpdateManyWithoutMeetingNestedInputObjectZodSchema = makeSchema();
