...
const Schema: z.ZodType<Prisma.CallSessionUncheckedUpdateManyWithoutMeetingNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const CallSessionUncheckedUpdateManyWithoutMeetingNestedInputObjectSchema =
  Schema;
