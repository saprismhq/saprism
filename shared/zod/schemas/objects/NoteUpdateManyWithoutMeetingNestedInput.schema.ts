...
const Schema: z.ZodType<Prisma.NoteUpdateManyWithoutMeetingNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => NoteUpsertWithWhereUniqueWithoutMeetingInputObjectSchema),
        z
          .lazy(() => NoteUpsertWithWhereUniqueWithoutMeetingInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => NoteUpdateWithWhereUniqueWithoutMeetingInputObjectSchema),
        z
          .lazy(() => NoteUpdateWithWhereUniqueWithoutMeetingInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
      .union([
        z.lazy(() => NoteUpdateManyWithWhereWithoutMeetingInputObjectSchema),
        z
          .lazy(() => NoteUpdateManyWithWhereWithoutMeetingInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const NoteUpdateManyWithoutMeetingNestedInputObjectSchema = Schema;
