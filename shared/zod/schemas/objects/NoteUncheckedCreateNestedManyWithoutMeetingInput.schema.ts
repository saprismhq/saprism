...
const Schema: z.ZodType<Prisma.NoteUncheckedCreateNestedManyWithoutMeetingInput> =
  z
    .object({
      create: z
        .union([
...
export const NoteUncheckedCreateNestedManyWithoutMeetingInputObjectSchema =
  Schema;
