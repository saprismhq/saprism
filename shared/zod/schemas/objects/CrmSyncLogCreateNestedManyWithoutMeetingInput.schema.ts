...
const Schema: z.ZodType<Prisma.CrmSyncLogCreateNestedManyWithoutMeetingInput> =
  z
    .object({
      create: z
        .union([
...
export const CrmSyncLogCreateNestedManyWithoutMeetingInputObjectSchema = Schema;
