...
const Schema: z.ZodType<Prisma.CallSessionCreateInput> = z
  .object({
    ...
    meeting: z.lazy(
      () => MeetingCreateNestedOneWithoutCallSessionsInputObjectSchema,
    ),
  })
  .strict();

export const CallSessionCreateInputObjectSchema = Schema;
