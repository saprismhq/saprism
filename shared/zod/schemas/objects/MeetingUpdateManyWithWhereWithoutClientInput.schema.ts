...
const Schema: z.ZodType<Prisma.MeetingUpdateManyWithWhereWithoutClientInput> = z
  .object({
...
export const MeetingUpdateManyWithWhereWithoutClientInputObjectSchema = Schema;
