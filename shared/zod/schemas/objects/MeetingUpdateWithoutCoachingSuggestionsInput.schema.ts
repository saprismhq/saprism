...
const Schema: z.ZodType<Prisma.MeetingUpdateWithoutCoachingSuggestionsInput> = z
  .object({
    clientName: z
      .union([
        z.string(),
...
export const MeetingUpdateWithoutCoachingSuggestionsInputObjectSchema = Schema;
