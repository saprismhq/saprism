...
const Schema: z.ZodType<Prisma.MeetingUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => MeetingUpsertWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => MeetingUpsertWithWhereUniqueWithoutUserInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => MeetingUpdateWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => MeetingUpdateWithWhereUniqueWithoutUserInputObjectSchema,
...
export const MeetingUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
