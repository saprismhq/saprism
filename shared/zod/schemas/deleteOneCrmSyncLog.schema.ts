...
export const CrmSyncLogDeleteOneSchema = z.object({ select: CrmSyncLogSelectObjectSchema.optional(), include: CrmSyncLogIncludeObjectSchema.optional(), where: CrmSyncLogWhereUniqueInputObjectSchema  })